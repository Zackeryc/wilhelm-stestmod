...
NCountry = {
	...
	REINFORCEMENT_DELIVERY_SPEED_MIN = 0.8,			-- The distance from the supply region to capital should affect the speed only a little bit. Main factor for penalty is overcrowded areas, and not the route length.
	REINFORCEMENT_EQUIPMENT_DELIVERY_SPEED = 0.8,	-- Modifier for army equipment reinforcement speed
	...
	NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_INFRA = 0.00, -- Reduce enemy national war support on nuking a province, the value scales with infrastructure up to this number
	NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_VP = 0.00,-- War support will be scaled down if there's less VP than this in the province
	...
	BASE_STABILITY_WAR_FACTOR = -0.05,				-- Default stability war factor
	...
	BASE_MOBILIZATION_SPEED = 0.20,					-- Base speed of manpower mobilization  #in 1/1000 of 1 %
	...
	BOMBING_WAR_SUPPORT_PENALTY_SCALE = 0.00000, 			-- Scaling of bomber damage to war support impact, will be added weekly as a war support penalty
	MAX_BOMBING_WEEKLY_WAR_SUPPORT_PENALTY = -0.00,			-- Max penalty that will gained per week from bomber's damage
	BOMBING_WEEKLY_WAR_SUPPORT_PENALTY_DECAY = 0.000,		-- Weekly decay of bomber damage war support penalty
	MAX_BOMBING_WAR_SUPPORT_IMPACT = 0.00,					-- Max total penalty from bomber's damage
	...
	MAX_HEROES_BEING_KILLED_WEEKLY_WAR_SUPPORT_PENALTY = 0.00,		-- Max penalty that will gained per week from war heroes manpower lost
	HEROES_BEING_KILLED_WEEKLY_WAR_SUPPORT_PENALTY_DECAY = 0.0001,	-- Weekly decay of war heroes manpower lost war support penalty
	MAX_HEROES_BEING_KILLED_WAR_SUPPORT_IMPACT = 0.00,				-- Max total penalty from war heroes manpower lost
	...
	MAX_CONVOYS_BEING_RAIDED_WAR_SUPPORT_IMPACT = 0.00,				-- Max total penalty from trade convoy raided
	
	
	CONVOYS_SUNK_MULTIPLIER_FOR_WAR_SUPPORT = 0.00,	-- once a trade convoy ship sunk, you will get a larger negative impact on your war support
	CONVOYS_BEING_RAIDED_DAILY_WAR_SUPPORT_IMPACT_FROM_OVERSEA_STATES = 0.00,	-- resource transfer convoys convoys from our states being raided will give a daily war support penalty depending on how important that resource is and how inefficent convoys are
	CONVOYS_SUNK_MULTIPLIER_FOR_WAR_SUPPORT_FROM_OVERSEA_STATES = 0.00,			-- once a resource transfer convoys from our states ship sunk, you will get a larger negative impact on your war support
	CONVOYS_BEING_RAIDED_DAILY_WAR_SUPPORT_IMPACT = 0.00,	-- trade convoys being raided will give a daily war support penalty depending on how important that resource is and how inefficent convoys are
...
NMilitary = {
	...
	TACTIC_SWAP_FREQUENCEY = 4,                   -- hours between tactic swaps
	...
	ENEMY_AIR_SUPERIORITY_IMPACT = -0.28,          -- effect on defense due to enemy air superiorty
...
UNIT_EXPERIENCE_PER_COMBAT_HOUR = .00015,	-- veterancy gain from combat 
	UNIT_EXPERIENCE_SCALE = .5,
	UNIT_EXPERIENCE_PER_TRAINING_DAY = .003, -- Veterancy gain from training 
	TRAINING_MAX_LEVEL = 2,
	DEPLOY_TRAINING_MAX_LEVEL = 1,
	TRAINING_EXPERIENCE_SCALE = 45.0, -- army xp gain from training 
	TRAINING_ORG = 0.15,
	ARMY_EXP_BASE_LEVEL = 1,
	UNIT_EXP_LEVELS = { 0.1, 0.3, 0.75, 0.9 },		-- Experience needed to progress to the next level
	FIELD_EXPERIENCE_SCALE = .002,
	...
	MAX_OUT_OF_SUPPLY_DAYS = 45, 				   -- how many days of shitty supply until max penalty achieved
	...
	ENCIRCLED_DISBAND_MANPOWER_FACTOR = 0.80,       -- percentage of manpower returned when an encircled unit is disbanded
	...
	RETREAT_SPEED_FACTOR = 0.35,                    -- speed bonus when retreating
...
NNavy = {
	...
	EXPERIENCE_LOSS_FACTOR = .65,                 					-- percentage of experienced solders who die when manpower is removed
